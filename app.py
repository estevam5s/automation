    ...
    if 'authenticated' not in st.session_state:
        ...
        if 'authenticated' in st.session_state and st.session_state.authenticated:
            ...
            selecionar = st.sidebar.selectbox("Selecione a página", [
                            "🏠 Home".capitalize(),
                            "Consultar Dados".capitalize(),
                            "Gráfico".capitalize(),
                            "Estatísticas de vendas".capitalize(),
                            "Relatórios financeiros".capitalize(),
                            "Análise de tendências".capitalize(),
                            "Histórico de vendas".capitalize(),
                            "Gerenciamento de estoque".capitalize(),
                            "Tipo de marmita mais vendido".capitalize(),
                            "Tipo de marmita menos vendido".capitalize(),
                            "Tipo de marmita mais lucrativo".capitalize(),
                            "Tipo de marmita menos lucrativo".capitalize(),
                            "Tipo de marita que saiu".capitalize(),
                            "Pedidos por Semana".capitalize(),
                            "Análise de Rentabilidade".capitalize(),
                            "Calcular Lucro".capitalize(),
                            "Consultar Lucro".capitalize(),
                            "Developers".capitalize(),
                            "About".capitalize(),
                            "Suporte ao cliente".capitalize(),
                            "Documentação".capitalize(),
                            "Ajuda e suporte".capitalize(),
                            "Sair".capitalize()
                            ]
                        )
